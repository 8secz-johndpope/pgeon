                ...
                <div>
                    <div class="media-body">
                        <div class="media-header m-b-5">
                            ...
                            <answeringtimer initial="{{$val->expiring_in}}"></answeringtimer></a><ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a id="end_now" rel="{{$val->id}}" href="#">End now <span class="fa fa-stop dropdown-icon"></span></a>
                                    </li>
                                    <li>
                                        <a id="cancel_now" rel="{{$val->id}}" href="#">Cancel <span class="fa fa-eject dropdown-icon"></span></a>
                                    </li>
                                </ul></span>
                        </div>
