...
<main class="landing-main mw6 m-auto">
  ...
  <div class="setting-input">
    ...
    <input type="password" class="setting-input__input" name="current-password" required>
  ...
  <div class="setting-input">
    ...
    <input type="password" class="setting-input__input" name="new-password" required>
    <span  class="m-auto mw6 db">
      <div class="border-trimmed"></div>
    </span>
  </div>
  ...
  <div class="setting-input">
    ...
    <input type="password" class="setting-input__input" name="new-password_confirmation" required>
    <span  class="m-auto mw6 db">
      <div class="border-trimmed"></div>
    </span>
  </div>
