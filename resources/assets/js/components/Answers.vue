         ...
         <div class="container">
          ...
          <div class="container">
              <div  v-for="answer in answers">
                                          ...
                                          <div class="media-list media-list-conversation c-w-md jsvote animated" v-bind:class="{ 'fade':  answer.id == pushed_id}"  v-if="ownerOfAnswer(answer.user_id)">
   ...
   No responses yet.. </h4>
           ...
           <div style="width: auto;box-shadow: inset 0px 0px .05 black;" v-else>
            ...
            <div  v-for="answer in answers"  v-bind:key="answer">
                            ...
                            <div class="media-list media-list-conversation c-w-md jsvote animated" v-bind:class="{ 'fade':  answer.id == pushed_id}" @mousedown="mdown(answer.id, $event)" @mouseup="mup(answer.id, $event)"   v-if="!ownerOfAnswer(answer.user_id)">
                <div class="media media-divider">
                    <div class="media-body">
