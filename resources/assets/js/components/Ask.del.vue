...
<main class="mw6 m-auto question-main">
  <div class="post-question-box mb20p">
    <textarea class="post-question-textarea orange-caret" placeholder="You last posted a question 3 hours ago" data-gramm_editor="false" autofocus maxlength="200"></textarea>
    ...
    <div class="post-question-share flex auto-share-toggle" >
      <a href="/connected-accounts" class="share-add share-circle fc mr20p">
          <%- include("../../public/img/svg/plus.svg") %>
      </a>
      ...
      <label class="share-social share-circle mr15p"for="twitter-share">
        ...
        <div class="svg-container svg-container--twitter fc">
          <%- include("../../public/img/svg/twitter.svg") %>
        </div>
      </label>
      ...
      <label class="share-social share-circle" for="facebook-share" >
        ...
        <div class="svg-container svg-container--fb  fc">
          <%- include("../../public/img/svg/facebook.svg") %>
        </div>
      </label>
    </div>
    <div class="post-question-action">
      <div>
        <div class="post-question-action__date">
          <%- include("../../public/img/svg/calendar-alt.svg") %>
          <span>

            <span class="pointer">
              <select class="no-r" name="">
                <% for(let i = 0; i < 7; i++ ){%>
                  <option value=""><%- "0" + i %> days %></option>
                <%}%>
              </select>
            </span> /
            <span class="pointer">
              <select class="no-r" name="">
                <% for(let i = 0; i < 24; i++ ){%>
                  <option value=""><%- i < 10 ? "0" + i : i %> hrs %></option>
                <%}%>
              </select>
            </span> /
            <span class="pointer">
              <select class="no-r" name="">
                <% for(let i = 0; i < 60; i++ ){%>
                  <option value=""><%- i < 10 ? "0" + i : i %> min %></option>
                <%}%>
              </select>
            </span>
          </span>
  ...
  <div class="question-stats">
    <a href="/question/live" class="question-stats__item">
      <div>
        <%- include("../../public/img/svg/ban.svg") %>
        <span>Open</span>
      </div>
      <span> 0 </span>
    </a>
    ...
    <a href="/question/pending" class="question-stats__item">
      <div>
        <%- include("../../public/img/svg/clock.svg") %>
        <span>Pending</span>
      </div>
      <span> 1 </span>
    </a>
    <a href="/question/published" class="question-stats__item">
      <div>
        <%- include("../../public/img/svg/check-circle.svg") %>
        <span>Published</span>
      </div>
      <span> 5 </span>
    </a>
